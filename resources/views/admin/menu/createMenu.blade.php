@extends('admin.layouts.index', ['title' => 'Menu', 'page_heading' => 'Tambah Menu Item'])
        ...
        <div class="my-3 p-3 rounded">
            <form method="post" action="{{ route('admin.storeMenu') }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" autofocus value="{{ old('nama_item') }}" 
                ...
                <div class="mb-3">
                    ...
                    <select name="kategori_id" id="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                        ...
                        @foreach($categories as $c)
                            <option value="{{ $c->id }}" {{ old('kategori_id') == $c->id ? 'selected' : '' }}>
                                {{ $c->nama_kategori }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" value="{{ old('harga') }}" 
                           name="harga" id="harga" 
